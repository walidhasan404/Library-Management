...
const BookCategories = () => {
    return (
        <div className="mb-4 px-4">
            <h2 className="text-4xl text-center font-bold mb-8">Categories</h2>
            ...
            <div className="card w-full bg-orange-50 p-3 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="text-center dark:text-black font-bold">Novel</h2>
                ...
                <div className="card w-full bg-orange-50 p-3 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="text-center dark:text-black font-bold">Science Fiction</h2>
                        <div className="card-actions mx-auto">
                ...
                <div className="card w-full bg-orange-50 p-3 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="text-center dark:text-black font-bold">Horror</h2>
                        <div className="card-actions mx-auto">
                ...
                <div className="card w-full bg-orange-50 p-3 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="text-center dark:text-black font-bold">Thriller</h2>
                        <div className="card-actions mx-auto">
