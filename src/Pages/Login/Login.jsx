...
const Login = () => {
    ...
    const { loggedInUser, signIn, handleGoogleSignIn, handleGoogleSignOut } = useContext(AuthContext);
        ...
        <div className="p-8 m-6 bg-sky-50">
            ...
            <form onSubmit={handleLogin}>
                ...
                <div className="form-control mt-6">
                    <input className="btn btn-primary bg-sky-600" type="submit" value="Login" />
                </div>
            </form>
            <div>
                {loggedInUser ?
